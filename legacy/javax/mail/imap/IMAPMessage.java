...
import com.s8.core.web.manganese.legacy.javax.mail.Address;
...
import com.s8.core.web.manganese.legacy.javax.mail.Header;
import com.s8.core.web.manganese.legacy.javax.mail.IllegalWriteException;
...
import com.s8.core.web.manganese.legacy.javax.mail.Session;
...
import com.s8.core.web.manganese.legacy.javax.mail.imap.protocol.BODY;
import com.s8.core.web.manganese.legacy.javax.mail.imap.protocol.BODYSTRUCTURE;
import com.s8.core.web.manganese.legacy.javax.mail.imap.protocol.ENVELOPE;
...
import com.s8.core.web.manganese.legacy.javax.mail.imap.protocol.INTERNALDATE;
...
import com.s8.core.web.manganese.legacy.javax.mail.imap.protocol.RFC822DATA;
import com.s8.core.web.manganese.legacy.javax.mail.imap.protocol.RFC822SIZE;
import com.s8.core.web.manganese.legacy.javax.mail.imap.protocol.UID;
import com.s8.core.web.manganese.legacy.javax.mail.internet.ContentType;
import com.s8.core.web.manganese.legacy.javax.mail.internet.InternetAddress;
import com.s8.core.web.manganese.legacy.javax.mail.internet.InternetHeaders;
import com.s8.core.web.manganese.legacy.javax.mail.internet.MimeMessage;
import com.s8.core.web.manganese.legacy.javax.mail.internet.MimeUtility;
import com.s8.core.web.manganese.legacy.javax.mail.util.ReadableMime;
...
public class IMAPMessage extends MimeMessage implements ReadableMime {
	...
	public synchronized DataHandler getDataHandler()
		...
		if (dh == null && !bodyLoaded) {
			 ...
			 */
			if (bs.isMulti())
				dh = new DataHandler("multipart/mixed",
						MailDataContentHandler.create("multipart/*"),
						new IMAPMultipartDataSource(this, bs.bodies, sectionId, this));
				 ...
				 */
				dh = new DataHandler(type, 
						MailDataContentHandler.create(type),
